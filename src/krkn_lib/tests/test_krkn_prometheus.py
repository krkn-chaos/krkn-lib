...
class TestKrknPrometheus(BaseTest):
    ...
    def test_process_prom_query_in_range_custom_granularity(self):
        ...
        with patch(
            ...
            prom_cli.process_prom_query_in_range(
    ...
    def test_process_prom_query_in_range_exception(self):
        ...
        with patch(
            ...
            mock_client = Mock()
            mock_prom.return_value = mock_client
            mock_client.custom_query_range.side_effect = Exception(
                "Query failed"
            )
    ...
    def test_process_query_exception(self):
        ...
        with patch(
            ...
            mock_client = Mock()
            mock_prom.return_value = mock_client
            mock_client.custom_query.side_effect = Exception(
                "Connection error"
            )
    ...
    def test_parse_metric_standard_replacement(self):
        ...
        with patch(
            ...
            description = (
                "10 minutes avg. 99th etcd commit "
                "{{$labels.instance}} latency"
    ...
    def test_parse_metric_underscore_label(self):
        ...
        with patch(
            ...
            description_underscore = (
                "10 minutes avg. 99th etcd commit "
                "{{$labels.instance}} "
                "latency on {{$labels.pod}} higher than 30ms. "
                "{{$labels.no_value}}"
            )
