...
class TestKrknElasticModels(BaseTest):
    ...
    def test_elastic_error_logs_conversion_from_none(self):
        ...
        # When error_logs is None, elastic error_logs should be None
    ...
    def test_elastic_error_logs_conversion_from_empty_list(self):
        ...
        # When error_logs is empty list (falsy), elastic error_logs should be None
        self.assertIsNone(elastic_telemetry.error_logs)
